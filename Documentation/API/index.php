...
<head>
<title>ByChance Framework - API Documentation - Table of Content</title>
...
<iframe id="TopicContent" name="TopicContent" class="TopicContent" src="html/N_ByChance_Configuration.htm">
